...
class Page3BlocDROPDOWNINPUTMANUAL extends StatelessWidget {
  /// {@macro counter_page}
  const Page3BlocDROPDOWNINPUTMANUAL({Key? key}) : super(key: key);
...
class _Page3BlocTableBodyINPUT extends StatelessWidget {
  /// {@macro counter_page}
  const _Page3BlocTableBodyINPUT({Key? key}) : super(key: key);
...
class INPUTMANUAL extends StatelessWidget {
  INPUTMANUAL({Key? key, this.data}) : super(key: key);
  String? data;
  @override
  Widget build(BuildContext context) {
    return Center(
